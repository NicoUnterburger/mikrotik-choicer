...
export default function MikroTikPortal() {
  ...
  const switchData = {
    ...
    'CRS312': {
      name: 'CRS312-4C+8XG-RM', sku: 'CRS312-4C+8XG-RM', category: 'crs-10g', color: '#14B8A6',
      ...
      notes: 'Günstige 10G-Aggregation',
    },
  };

  const switchCategories = { all: 'Alle', css: 'CSS (SwOS)', 'crs-copper': 'CRS Copper', 'crs-poe': 'CRS PoE', 'crs-sfp': 'CRS SFP+', 'crs-10g': 'CRS 10G' };
